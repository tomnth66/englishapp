		...
		return (
			<footer class="footer-distributed">
				<div class="footer-left">
					...
					<div class="footer-icons">
						<a
							href="https://www.facebook.com/Virtual-English-lessons-with-San-Adams-244350032274158/"
							target="_blank"
						>
							<i className="fa fa-facebook"></i>
						</a>
						<a href="https://zalo.me/0962394488" target="_blank">
          ...
          <input type="text" id="FormEmail" name="email" placeholder="Email"></input>
					...
					<form
						...
						action="https://formspree.io/xknzgbno"
						method="POST"
					>
						<div className={classFirst}>
							...
							<Button
								color="primary"
								variant="contained"
								onClick={this.changeFooterState.bind(this)}
							>
								Next
							</Button>
						</div>
						...
						<div className={classSecond}>
							<div class="footer-icons backBtn">
								<span onClick={this.changeFooterState.bind(this)}>
									<i className="fa fa-arrow-left"></i>
								</span>
							</div>
							<textarea name="message" placeholder="Your message"></textarea>
							<input
								className="footerFormBtn"
								type="submit"
								value="Send"
							></input>
						</div>
